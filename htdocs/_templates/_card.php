<div class="col mb-5">
    <div class="card rounded mx-auto d-block" style="width: 18rem; ">
        <div class="position-relative w-100 img-overly ">
            <img  src="<?php echo $key['img_uri'] ?>" class=" " width="100%" height="350px" id="card-img" alt="...">
            <?php
            if ((int) $key['offer'] > 0) {
            ...
            <div class="position-absolute bottom-0 d-flex w-100">
                ...
                <a role="button" class="btn d-none btn-primary rounded-0 w-50 hover-btn-container" id="btnQuickView" onclick="QuickView(this)">View</a>
                <span hidden>Pid:<?php echo $key['pid'] ?> </span>
